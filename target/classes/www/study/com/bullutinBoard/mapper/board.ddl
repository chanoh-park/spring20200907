...
-- 게시글 테스트 데이터
insert into t_post (hierarchy_id, bb_id, writer_id, content, post_type, title) values ('1', -1, -10000000, '안녕', 'POST', '하세요');
insert into t_post (hierarchy_id, bb_id, writer_id, content, post_type, title) values ('2', -1, -20000000, '고객님', 'POST', '많이 사세요');


-- 댓글 테스트 데이터
insert into t_post (hierarchy_id, writer_id, content) values ('1-3', -10000001, 'U 2');
insert into t_post (hierarchy_id, writer_id, content) values ('1-3-4', -10000000, '답변 주셔서 감사합니다.');
