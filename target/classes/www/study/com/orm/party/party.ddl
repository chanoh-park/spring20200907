...
-- id, name, birth_date, party_type, gender, salesTot
...
insert into t_party (id, name, birth_date, party_type, gender) values (-10000000, '홍길동', '1500.01.01', 'PERSON', 'mail');
insert into t_party (id, name, birth_date, party_type, gender) values (-10000001, '이순신', '1600.01.01', 'PERSON', 'mail');
insert into t_party (id, name, birth_date, party_type, sales_tot) values (-20000000, '대한', '2000.01.01', 'ORGANIZATION', '23423191899');
...
select id from t_hash_tag where name = '개인화';

insert into m_party_hash_tag(party_id, tag_id)
	select -10000000, id from t_hash_tag
	where name = '개인화';
